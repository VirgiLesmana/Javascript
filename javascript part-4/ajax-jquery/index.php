    ...
    <div class="modal-content">
      ...
      <form>
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="form-text">Harus Diisi YA!</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Alamat</label>
                        <input type="text" class="form-control" id="alamat" Required>
                        <div id="emailHelp" class="form-text">Harus Diisi YA! teman teman</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Telp</label>
                        <input type="text" class="form-control" id="telp" Required>
                        <div id="emailHelp" class="form-text">Siapa Yang Disini Cita-Citanya Mengisi Ini</div>
                    </div>
